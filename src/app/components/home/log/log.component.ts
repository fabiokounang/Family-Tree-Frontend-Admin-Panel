...
import { LogPaginatedInterface } from 'src/app/interfaces/logpagination.interface';
...
export class LogComponent implements OnInit {
  ...
  getAllData () {
    this.loader = true;
    this.apiService.connection('POST', 'master-log', this.tableQueryData).subscribe({
      next: (response: LogPaginatedInterface) => {
